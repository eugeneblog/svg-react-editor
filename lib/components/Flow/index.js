...
var Flow = /*#__PURE__*/ (function(_React$Component) {
  ...
  function Flow() {
    ...
    _this.width = 1000;
    _this.height = 500;
    _this.containerId = ''.concat(_constants.FLOW_CONTAINER_ID, '_container');

    _this.initGraph = function() {
      var _assertThisInitialize = _assertThisInitialized(_this),
        containerId = _assertThisInitialize.containerId,
        width = _assertThisInitialize.width,
        height = _assertThisInitialize.height;

      var data = _this.props.data; // @ts-ignore
      ...
      svg.call(zoom);
      d3.select('#'.concat(containerId)).append(function() {
        return svg.node();
      });
    };
